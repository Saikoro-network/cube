...
/**
 * Fetches UUID via BungeeCord's ProxiedPlayer#getUniqueId function.
 * @see net.md_5.bungee.api.connection.ProxiedPlayer.getUniqueId()
 */
class BungeeUUIDFetcher : UUIDFetcher() {
    override fun getUniqueId(player: ProxiedPlayer): UUID = player.uniqueId
}